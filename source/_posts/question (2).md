...
3：[redis](https://www.nowcoder.com/jump/super-jump/word?word=redis) 的跳表底层实现复杂度等等

4：[redis](https://www.nowcoder.com/jump/super-jump/word?word=redis)为何用跳表而不用[红黑树](https://www.nowcoder.com/jump/super-jump/word?word=红黑树)
